...
import { LuChevronRight as ChevronRight, LuCheck as Check } from "react-icons/lu";
...
function ContextMenuLabel({
	...
	return <ContextMenuPrimitive.Label data-slot="context-menu-label" data-inset={inset} className={cn("px-1.5 py-1 text-xs font-medium text-muted-foreground data-inset:pl-7", className)} {...props} />;
}
